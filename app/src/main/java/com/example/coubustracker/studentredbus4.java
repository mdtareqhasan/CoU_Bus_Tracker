                        ...
                        if (loc != null) {
                            ...
                            tvLocationLink.setOnClickListener(v -> {
                                ...
                                if (url == null || url.isEmpty()) {
                                    Toast.makeText(studentredbus4.this, "Location link not available", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                            ...
                            Toast.makeText(studentredbus4.this, "Red Bus 2 not found", Toast.LENGTH_SHORT).show();
                        }
                    }
